# -*- coding: utf-8 -*-
#
# pytest-catch-server documentation build configuration file, created by
...
project = u'pytest-catch-server'
copyright = u'2015, Jan Bednařík'
author = u'Jan Bednařík'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-catch-server Documentation',
     [author], 1)
]
